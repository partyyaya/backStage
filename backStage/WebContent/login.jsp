...
<div class="container">
	<div class="row">
        ...
        <form class="col-sm-4 form-horizontal" action="loginMember"  method='post' role="form" style="margin-top:17%;border-radius: 4px;border: 2px solid rgba(95,95,107,0.5);background-color: rgba(52,52,59,0.7);">
            <div class="form-group">
            <label for="userName" class="col-sm-3 control-label" style="margin-top:2px;font-size:22px;color:black;">登入</label>    	  
            </div>
            <div class="form-group" style="margin-top:2px">
            <label for="passwd" class="col-sm-3 control-label" style="color:black;font-size:15px;">帳號:</label>
                <div class="col-sm-6">
